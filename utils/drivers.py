...
def get_dataloader(img_size, dataset, datapath, batch_size, interpolation, no_val, slim_dataaug=False):
    ...
    if img_size == 32:
        ...
        if slim_dataaug:
            ...
            train_set = eval(dataset)('{}/train'.format(datapath), transform=transforms.Compose([
                    transforms.RandomResizedCrop(224, scale=(crop_scale, 1.0), interpolation=interpolation),
